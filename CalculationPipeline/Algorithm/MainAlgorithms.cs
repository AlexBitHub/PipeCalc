...
namespace CalculationPipeline
{
    static class MainAlgorithms
    {
        ...
        /// </summary>
        static double NumberReynolds(float Q, float d, float visc)
        {
        ...
        /// </summary>
        static double HydroResist(float rough, float reyn)
        {
            double resist;
        ...
        /// </summary>
        static double HydroLosses(float resist, float Q, float d)
        {
